...
while not gameExit:
	...
	pygame.draw.circle(gameDisplay, green, (100,150),15,0)
	pygame.draw.lines(gameDisplay, green, False, [(90,90), (100,85), (100,200)], 2)
	pygame.draw.rect(gameDisplay, blue, [600,400, 20, 100])
	pygame.draw.rect(gameDisplay, red, [200,100, 50, 100])
	pygame.draw.circle(gameDisplay, black, (75,100), 20, 0)
	pygame.draw.lines(gameDisplay, red, False, [(500,500), (300,200), (400,100)], 2)
